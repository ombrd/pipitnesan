...
class WorkoutPlanPolicy
{
    ...
    {
        return $user->can('view_any_workout::plan');
    }
    ...
    {
        return $user->can('create_workout::plan');
    }
    ...
    {
        return $user->can('update_workout::plan');
    }
    ...
    {
        return $user->can('delete_workout::plan');
    }
     ...
     */
    public function replicate(User $user, WorkoutPlan $workoutPlan): bool
    {
